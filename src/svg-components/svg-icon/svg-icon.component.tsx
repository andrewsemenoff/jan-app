...
const getSvgPath = (path: SVG_PATH) =>
  ({
    ...
    [SVG_PATH.SORT_ALPHABET_ASCENDING]: SORT_ALPHABET_ASCENDING,
    [SVG_PATH.SORT_ALPHABET_DESCENDING]: SORT_ALPHABET_DESCENDING,
    [SVG_PATH.SORT_AMOUNT_ASCENDING]: SORT_AMOUNT_ASCENDING,
    [SVG_PATH.SORT_AMOUNT_DESCENDING]: SORT_AMOUNT_DESCENDING,
    [SVG_PATH.MEMBERS]: MEMBERS,
  }[path]);
